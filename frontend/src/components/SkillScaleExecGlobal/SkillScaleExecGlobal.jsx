import styles from './styles/SkillScaleExecGlobal.module.css';

export const SkillScaleExecGlobal = ({ skill, level, className }) => {
  const maxLevel = 10;
  ...
  return (
    <div className={`${styles.setofskillsblock} ${className}`}>
